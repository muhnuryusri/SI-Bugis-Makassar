...
import com.example.bugismakassar.databinding.ActivityEditHotSpotAdminBinding
...
class EditHotSpotAdminActivity : AppCompatActivity() {
    private lateinit var binding: ActivityEditHotSpotAdminBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditHotSpotAdminBinding.inflate(layoutInflater)
