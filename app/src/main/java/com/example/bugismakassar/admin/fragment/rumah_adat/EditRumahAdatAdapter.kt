...
import com.example.bugismakassar.admin.fragment.pakaian_adat.EditPakaianAdatActivity
...
class EditRumahAdatAdapter (val context: Context?, private val listArticle: ArrayList<Article>) : RecyclerView.Adapter<RecyclerView.ViewHolder>()  {
