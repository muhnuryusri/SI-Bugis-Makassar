...
import com.example.bugismakassar.admin.fragment.lontara.EditLontaraActivity
...
class EditMusikTradisionalAdapter (val context: Context?, private val listArticle: ArrayList<Article>) : RecyclerView.Adapter<RecyclerView.ViewHolder>()  {
