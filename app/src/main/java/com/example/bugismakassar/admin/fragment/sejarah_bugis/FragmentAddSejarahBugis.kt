...
class FragmentAddSejarahBugis : Fragment() {
    private lateinit var binding : FragmentAddSejarahBugisBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAddSejarahBugisBinding.inflate(layoutInflater)
        return binding.root
    }
...
/*        database.child(title).setValue(article)
