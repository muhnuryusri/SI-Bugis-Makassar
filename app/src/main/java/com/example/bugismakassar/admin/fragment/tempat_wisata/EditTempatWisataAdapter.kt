...
import com.example.bugismakassar.admin.fragment.tarian_tradisional.EditTarianTradisionalActivity
...
class EditTempatWisataAdapter (val context: Context?, private val listArticle: ArrayList<Article>) : RecyclerView.Adapter<RecyclerView.ViewHolder>()  {
