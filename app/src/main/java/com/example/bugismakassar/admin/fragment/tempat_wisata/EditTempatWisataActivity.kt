...
import com.example.bugismakassar.databinding.ActivityEditTempatWisataBinding
...
class EditTempatWisataActivity : AppCompatActivity() {
    private lateinit var binding: ActivityEditTempatWisataBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditTempatWisataBinding.inflate(layoutInflater)
        ...
        binding.btnUpdate.setOnClickListener {
            ...
            mediaData?.let { it1 ->
                storage.putFile(it1).addOnSuccessListener(OnSuccessListener { taskSnapshot ->
                    ...
                    Toast.makeText(this@EditTempatWisataActivity,"Update Berhasil", Toast.LENGTH_SHORT).show()
                })
            }
        }
    }
    ...
    private fun updateDataToFirebaseDatabase(profileImageUrl: String, article: Article) {
        ...
        article.id?.let {
            database.child(it).setValue(articleData).addOnSuccessListener {
                ...
                Toast.makeText(this@EditTempatWisataActivity, "Update Berhasil", Toast.LENGTH_SHORT).show()
                val intent = Intent(this@EditTempatWisataActivity, AdminActivity::class.java)
                startActivity(intent)
            }
                .addOnFailureListener {
                    Toast.makeText(this@EditTempatWisataActivity,"Update Gagal", Toast.LENGTH_SHORT).show()
                }
        }
    }
