...
import com.example.bugismakassar.databinding.ActivityEditTempatWisataVideoBinding
...
class EditTempatWisataActivityVideo : AppCompatActivity() {
    private lateinit var binding: ActivityEditTempatWisataVideoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditTempatWisataVideoBinding.inflate(layoutInflater)
            ...
            if (mediaData !== null) {
                ...
                mediaData?.let { it1 ->
                    storage.putFile(it1).addOnSuccessListener(OnSuccessListener { taskSnapshot ->
                        ...
                        Toast.makeText(this@EditTempatWisataActivityVideo,"Update Berhasil", Toast.LENGTH_SHORT).show()
    ...
    private fun updateDataToFirebaseDatabase(profileImageUrl: String, article: Article) {
        ...
        article.id?.let {
            database.child(it).setValue(articleData).addOnSuccessListener {
                ...
                Toast.makeText(this@EditTempatWisataActivityVideo, "Update Berhasil", Toast.LENGTH_SHORT).show()
                val intent = Intent(this@EditTempatWisataActivityVideo, AdminActivity::class.java)
                startActivity(intent)
            }
                .addOnFailureListener {
                    Toast.makeText(this@EditTempatWisataActivityVideo,"Update Gagal", Toast.LENGTH_SHORT).show()
                }
        }
    }
