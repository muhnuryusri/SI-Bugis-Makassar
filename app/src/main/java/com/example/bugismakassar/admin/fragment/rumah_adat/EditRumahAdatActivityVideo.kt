...
import com.example.bugismakassar.databinding.ActivityEditRumahAdatVideoBinding
...
class EditRumahAdatActivityVideo : AppCompatActivity() {
    private lateinit var binding: ActivityEditRumahAdatVideoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditRumahAdatVideoBinding.inflate(layoutInflater)
            ...
            if (mediaData !== null) {
                ...
                mediaData?.let { it1 ->
                    storage.putFile(it1).addOnSuccessListener(OnSuccessListener { taskSnapshot ->
                        ...
                        Toast.makeText(this@EditRumahAdatActivityVideo,"Update Berhasil", Toast.LENGTH_SHORT).show()
    ...
    private fun updateDataToFirebaseDatabase(profileImageUrl: String, article: Article) {
        ...
        article.id?.let {
            database.child(it).setValue(articleData).addOnSuccessListener {
                ...
                Toast.makeText(this@EditRumahAdatActivityVideo, "Update Berhasil", Toast.LENGTH_SHORT).show()
                val intent = Intent(this@EditRumahAdatActivityVideo, AdminActivity::class.java)
                startActivity(intent)
            }
                .addOnFailureListener {
                    Toast.makeText(this@EditRumahAdatActivityVideo,"Update Gagal", Toast.LENGTH_SHORT).show()
                }
        }
    }
