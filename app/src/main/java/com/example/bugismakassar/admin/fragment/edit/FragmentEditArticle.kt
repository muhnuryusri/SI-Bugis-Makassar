...
import com.example.bugismakassar.databinding.FragmentEditArticleBinding
...
class FragmentEditArticle : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditArticleBinding.inflate(layoutInflater)
        return binding.root
    }
