...
class FragmentAddPakaianAdat : Fragment() {
    private lateinit var binding : FragmentAddPakaianAdatBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAddPakaianAdatBinding.inflate(layoutInflater)
        return binding.root
    }
