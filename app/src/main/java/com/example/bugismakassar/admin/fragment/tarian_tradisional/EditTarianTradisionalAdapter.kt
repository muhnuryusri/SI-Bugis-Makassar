...
import com.example.bugismakassar.admin.fragment.sejarah_bugis.EditSejarahBugisActivity
...
class EditTarianTradisionalAdapter (val context: Context?, private val listArticle: ArrayList<Article>) : RecyclerView.Adapter<RecyclerView.ViewHolder>()  {
