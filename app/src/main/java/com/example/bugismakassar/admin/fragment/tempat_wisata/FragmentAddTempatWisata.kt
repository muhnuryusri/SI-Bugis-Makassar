...
class FragmentAddTempatWisata : Fragment() {
    private lateinit var binding : FragmentAddTempatWisataBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAddTempatWisataBinding.inflate(layoutInflater)
        return binding.root
    }
