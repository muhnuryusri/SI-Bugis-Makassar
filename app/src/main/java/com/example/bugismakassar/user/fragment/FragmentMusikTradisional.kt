...
import com.example.bugismakassar.databinding.FragmentMusikTradisionalBinding
import com.example.bugismakassar.user.fragment.adapter.ArticleAdapter
import com.google.firebase.database.*

class FragmentMusikTradisional : Fragment() {
    private lateinit var binding : FragmentMusikTradisionalBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMusikTradisionalBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvMusikTradisional.layoutManager = LinearLayoutManager(activity)
        binding.rvMusikTradisional.setHasFixedSize(true)
        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()){
                    ...
                    binding.rvMusikTradisional.adapter = ArticleAdapter(listArticle)
                }
            }
